...
/**
 * Class TDPRB_Natural_Settings
 *
 * Handles the Natural settings for the TDPRB plugin.
 */
class TDPRB_Natural_Settings {
    ...
    public function render() {
        include(TDPRB_DIR_PATH . "/admin/partials/tdprb-admin-natural-settings.php");
    }
    ...
    public function register() {
        register_setting(
            'tdprb_natural_settings_group', // Option group
            'tdprb_natural_settings', // Option name
            [
                'type'              => 'array',
                'sanitize_callback' => [$this, 'sanitizeSettings'],
                'default'           => $this->defaultNaturalSetting(),
            ]
        );
    }
     ...
     */
    public function defaultNaturalSetting() {
        return [
			'diamond_title' => 'Natural Diamonds',
